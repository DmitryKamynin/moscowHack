"""
Django settings for moscowhackathon project.
...
SECRET_KEY = 'django-insecure-m-^)0hf9&z1$ek2yeobzahflkytboyfgf2z9_(xbgv^x$a0ml-'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ["185.185.69.68", "127.0.0.1"]
...
WSGI_APPLICATION = 'moscowhackathon.wsgi.application'
